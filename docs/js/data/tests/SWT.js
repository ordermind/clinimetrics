...
export default new Test({
    ...
    description: `
De Shuttle Walk Test is een maximale inspanning test die gebruikt kan worden om de <strong>functionele capaciteit</strong> of inspanningstolerantie van personen te bepalen. De test kan worden gebruikt om een indruk te krijgen van VO2<sub>MAX</sub>. Doelgroep: patiënten met cardiale problematiek of COPD.
    `.trim(),
    templateContent,
